    ...
    <section id="contact" className="relative pt-24 pb-12 md:pt-24 md:pb-16 px-6 md:px-24 border-t border-brand-border z-20 min-h-screen bg-brand-background text-brand-text overflow-hidden">
      <GridPattern
        ...
        className={cn(
          ...
          "absolute inset-0 z-0 w-full h-full opacity-50 pointer-events-none"
        )}
      />
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-16">
        <div>
          ...
          <h2 className="text-4xl md:text-6xl font-display font-medium mb-12 md:mb-16 leading-[0.9] tracking-tighter">
            START YOUR <br /><span className="text-brand-green italic serif">JOURNEY</span> WITH US.
          </h2>
